...
let package = Package(
    ...
    targets: [
        .target(name: "mtd-blog", dependencies: [ .target(name: "Application"), "Kitura" , "HeliumLogger", "KituraStencil", "CouchDB", "PromiseKit", "FileKit", "KituraOpenAPI"]),
        .target(name: "Application", dependencies: [ "Kitura", "CloudEnvironment","SwiftMetrics", "Health", "KituraStencil", "CouchDB", "PromiseKit", "FileKit", "KituraMarkdown", "MTDBlogComponents"]),
